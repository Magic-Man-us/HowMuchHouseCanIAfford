...
export function NavRail({ activeSection, setActiveSection, onExport, onSave, onLoad, onShare, shareTooltip }) {
  return (
    <div style={{
      ...
      {/* App Switcher */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginBottom: 20, width: '100%', padding: '0 6px' }}>
        <a
          href="https://magic-man-us.github.io/HowMuchCarCanIAfford/"
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 17h14M5 17a2 2 0 0 1-2-2V9l2.5-5h13L21 9v6a2 2 0 0 1-2 2M5 17a2 2 0 1 0 4 0m6 0a2 2 0 1 0 4 0"/></svg>
          Auto
        </a>
        <div
          style={{
